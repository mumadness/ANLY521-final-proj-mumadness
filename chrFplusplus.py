...
def computeChrF(fpRef, fpHyp, nworder, ncorder, beta, sentence_level_scores = None):
    ...
    return totalF, averageTotalF, totalPrec, totalRec, sent_scores
...
#
#     totalF, averageTotalF, totalPrec, totalRec, sent_scores = computeChrF(rtxt, htxt, args.nworder, args.ncorder, args.beta, sentence_level_scores)
#
